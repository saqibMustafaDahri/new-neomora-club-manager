  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className={clsx(
        ...
        error 
          ? "[&_input]:border-danger [&_input]:focus:border-danger [&_input]:focus:ring-danger [&_textarea]:border-danger [&_textarea]:focus:border-danger [&_textarea]:focus:ring-danger" 
          : "[&_input]:border-border [&_input]:focus:border-primary [&_input]:focus:ring-primary [&_textarea]:border-border [&_textarea]:focus:border-primary [&_textarea]:focus:ring-primary"
      )}>
        {children(id)}
      </div>
