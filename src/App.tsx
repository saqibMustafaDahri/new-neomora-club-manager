...
//         {/* ── Parent ──────────────────────────────────────── */}
//         <Route path="/parent" element={<ParentShell navItems={parentNav} />}>
//           <Route index element={<Navigate to="dashboard" replace />} />
...
// import { Notifications as ParentNotifications } from './pages/parent/Notifications';
// import { ParentTopShell } from './components/layout/ParentTopShell';
...
//         {/* ── Parent ──────────────────────────────────────── */}
//         <Route path="/parent" element={<ParentTopShell />}>
//           <Route index element={<Navigate to="dashboard" replace />} />
//           <Route path="dashboard" element={<ParentDashboard />} />
//           <Route path="child/:studentId" element={<ChildProfile />} />
//           <Route path="payments" element={<ParentPayments />} />
...
// import { Register as SuperAdminRegister } from './pages/super-admin/Register';
// import { RegistrationForm as SuperAdminRegistrationForm } from './pages/super-admin/RegistrationForm';
// import { Notifications as SuperAdminNotifications } from './pages/super-admin/Notifications';
// import { SystemLogs as SuperAdminSystemLogs } from './pages/super-admin/SystemLogs';
// import { Enquiries as SuperAdminEnquiries } from './pages/super-admin/Enquiries';
// import { Schedule as LocationManagerSchedule } from './pages/location-manager/Schedule';
// import { Roster as LocationManagerRoster } from './pages/location-manager/Roster';
// import { Waitlist as LocationManagerWaitlist } from './pages/location-manager/Waitlist';
// import { RateCards as FinanceRateCards } from './pages/finance/RateCards';
...
//           <Route path="system-logs" element={<SuperAdminSystemLogs />} />
//         </Route>
...
import { LoginSelect } from './pages/LoginSelect';
import { UIKit } from './pages/UIKit';
import { Apply as PublicApply } from './pages/public/Apply';
...
import { SystemLogs as SuperAdminSystemLogs } from './pages/super-admin/SystemLogs';
import { Enquiries as SuperAdminEnquiries } from './pages/super-admin/Enquiries';
import { RegistrationRequests as SuperAdminRegistrationRequests } from './pages/super-admin/RegistrationRequests';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Public, unauthenticated registration request form - no shell, no login required */}
        ...
        <Route path="/super-admin" element={<AppShell navItems={superAdminNav} />}>
          ...
          <Route path="register-form" element={<SuperAdminRegistrationForm />} />
          <Route path="enquiries" element={<SuperAdminEnquiries />} />
          <Route path="registration-requests" element={<SuperAdminRegistrationRequests />} />
          <Route path="notifications" element={<SuperAdminNotifications />} />
          <Route path="system-logs" element={<SuperAdminSystemLogs />} />
        </Route>
